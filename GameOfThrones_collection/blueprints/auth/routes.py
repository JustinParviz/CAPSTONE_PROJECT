...
#internal import 
from GameOfThrones_collection.models import User, db 
from GameOfThrones_collection.forms import RegisterForm, LoginForm
...
def signup():
    ...
    #instantiating the form as an object in order to use it:
    registerform = RegisterForm()

    if request.method == 'POST' and registerform.validate_on_submit():
        #grabbing the data from the form after it was submitted 
